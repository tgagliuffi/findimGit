...
public class FirmaContratoBean {
	...
	private String rutaSignBoxContract;
	...
	public String getRutaSignBoxContract() {
		return rutaSignBoxContract;
	}

	public void setRutaSignBoxContract(String rutaSignBoxContract) {
		this.rutaSignBoxContract = rutaSignBoxContract;
	}
